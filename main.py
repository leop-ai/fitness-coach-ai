...
Rules:
- Write in flowing natural prose like a real person typed it — no bullet points, no numbered lists, no structured formatting
- Never quote the client's words back at them directly using quotation marks
- Weave in references to what they said naturally, don't interrogate them line by line
- Match the coaching style exactly — if direct, be direct but human. If motivational, be energetic but real
- End with ONE clear action for next week woven naturally into the message
- Max 120 words
- No generic phrases like "great job", "keep it up", or "I believe in you"
- Sound like a real coach messaging their client, not an AI generating a structured report
